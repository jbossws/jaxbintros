...
## Git Setup
To contribute, you first need to fork the [jaxbintros](https://github.com/jbossws/jaxbintros) repository.
...
```
To pull update from the jaxbintros upstream, the jaxbintros remote can be added to your local git repo :
```
git remote add upstream https://github.com/jbossws/jaxbintros.git
```
Before change/fix, always pull update from jaxbintros:
```
$ git checkout -f main
